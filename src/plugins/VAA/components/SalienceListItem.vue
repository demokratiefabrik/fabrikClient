...
<template>
  <q-expansion-item
    ...
    v-model="expanded"
    :ref="`expandable`"
    :header-class="['text-primary', 'text-h4',  expanded ? 'bg-grey-2': (!isSalienced ? 'bg-orange' : '')]"
  >
    ...
    <template v-slot:header="prop">
      <q-item class="full-width">
        ...
        >
          ...
          >Verbesserung vorgeschlagen<q-tooltip>Für diese Frage wurde eine Verbesserung<br>vorgeschlagen, die gerade begutachtet wird. </q-tooltip>
          </q-badge>
