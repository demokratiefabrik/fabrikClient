<template>
  ...
  <q-page class="doc_content">
    ...
    <div v-if="ready && $loaded(this.salienceCompleted)">
      ...
      <p>
        Je wichtiger die Themen für die Bürgerinnen und Bürger sind, desto mehr Platz erhalten sie im smartvote-Fragebogen.
      </p>
      ...
      <p>Wir stellen Ihnen hier die verschiedenen Themengebiete vor, welche standardmässig mit dem smartvote-Fragebogen abgedeckt werden. Geben Sie hier an, wie wichtig Ihnen die einzelnen Themen sind.</p>
      <SalienceList
      ...
      <div v-if="milestoneSALIENCE">
        ...
        Sie sehen hier nun die von Ihnen angegebene Wichtigkeit der Themen in einem Netzdiagramm.
        Je wichtiger die Themen für Sie sind, desto weiter draussen im Spinnennetz verläuft die farbige Linie. Bei Themen, die Ihnen nicht wichtig erscheinen, nähert sich die farbige Linie der Mitte an.
