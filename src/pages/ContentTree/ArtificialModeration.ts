const AMs = {
    ...
    items: [
      {
        ...
        prosa: 'Nichts bisher',
        body: () =>
          'Noch hat niemand hierzu etwas geschrieben. Möchten Sie den Anfang machen?',
      },
      // {
      //   id: 2,
      //   condition: (ctx) => ctx.node.nof_descendants === 0,
      ...
      },
      {
        ...
        body: () =>
          'Da gibt es viele neue Beiträge in diesem Forum. Wollen Sie sich mal umsehen?',
      },
      {
        id: 5,
      ...
      },
      {
        ...
        condition: (ctx) =>
          ctx.node.nof_descendants_unread > 1 &&
          ctx.node.nof_descendants_unread <= 3,
  ...
  indexTopBasicDefaultExtension: {
    ...
    prosa:
      'Ergänzt die indexTop AMs sofern keine anderen custom AMs mitgegeben wurden. => Zugeschnitten auf generelle Diskussion zu einem spezifischen Text/Thema',
    loading: (ctx) => !ctx.node.children,
    items: [
      {
        id: 1,
        ...
        prosa: 'Nichts bisher',
        body: () =>
          'Machen Sie hier den Anfang? Was denken Sie zu diesem Thema?',
      },
      {
        id: 2,
        condition: (ctx) =>
          ctx.node.nof_descendants > 0 && ctx.node.nof_descendants < 7,
        prosa:
          'Gibt es Dinge, die Sie zum gelesenen Text noch erläutern möchten. Haben Sie Fragen dazu?',
        body: () =>
          'Gibt es Dinge, die Sie noch erläutern möchten? Haben Sie Fragen? Schreiben Sie doch einen Beitrag?',
      },
    ],
  },
};
