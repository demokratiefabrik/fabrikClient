    ...
    items: [
      ...
      },
      {
        ...
        condition: (ctx) =>
          ...
          !ctx.is_stage_last_shown(ctx.currentSelectedStage) &&
          !ctx.is_stage_completed(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.enter_continue'),
      },
      {
        id: 3,
        condition: (ctx) => ctx.is_stage_completed(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.already_completed'),
      },
      {
        id: 3,
        condition: (ctx) =>
          ...
          ctx.is_stage_last_shown(ctx.currentSelectedStage) &&
          !ctx.is_stage_completed(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.enter_end'),
      },
      {
        id: 4,
        condition: (ctx) =>
          ...
          ctx.is_stage_last_shown(ctx.currentSelectedStage) &&
          !ctx.is_stage_completed(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.enter_unique_stage'),
      },
      {
        id: 5,
        condition: (ctx) => ctx.is_stage_scheduled(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.attention_needed'),
      },
      {
        id: 6,
        condition: (ctx) =>
          ...
          !ctx.is_stage_last_shown(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.already_seen'),
      },
      {
        id: 7,
        prosa:
        ...
        condition: (ctx) =>
          !ctx.is_stage_scheduled(ctx.currentSelectedStage) &&
          ctx.is_stage_last_shown(ctx.currentSelectedStage),
        body: (ctx) => ctx.$t('stages.am.all_stages_already_seen'),
      },
    ],
    ...
    buttons: [
      {
        ...
        label: (ctx) => ctx.$t('stages.goto_next_stage'),
        icon_right: 'mdi-arrow-down',
      },
      {
        condition: (ctx) => ctx.is_stage_scheduled(ctx.currentSelectedStage),
        action: (ctx) => ctx.gotoStage(ctx.currentSelectedStage),
        label: (ctx) => ctx.$t('stages.please_enter_stage'),
