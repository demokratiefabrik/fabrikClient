    ...
    >
      ...
      <h3>
        {{
          localmodel.id
            ? 'Assembly bearbeiten'
            : 'Fügen Sie einen neuen Assembly hinzu'
        }}
      </h3>
      Hinweis: Es kann eine Weile dauern, bis der lokale Cache im Browser
      ersetzt wird. Um Änderungen zu testen verwende am besten den Inkognito
      oder Private-Modus deines Browsers.<br />
      ...
      <div class="bg-grey-2 q-mt-lg">
        <div class="q-gutter-y-md column q-pa-md" style="width: 100%">
          ...
          <div v-if="errorInfo" class="red-5 q-field--error text-negative">
          ...
          <b>Starting Date {{ formatDate_localmodel_date_start }}</b>
          <div v-if="!localmodel.date_start">
            {{ 'The citizenmodul is now enabled' }}
          </div>
          <div>
            <q-btn
              class="q-ma-none"
            ...
            <q-btn
              ...
              icon="mdi-close"
              @click.stop="
                show_date_start_selector = false;
                localmodel.date_start = null;
              "
            />
          </div>
          <div
          ...
          <div>
            ...
            <q-btn
              ...
              icon="mdi-close"
              @click.stop="
                show_date_end_selector = false;
                localmodel.date_end = null;
              "
            />
          </div>
          <div
...
export default defineComponent({
  ...
  methods: {
    ...
    save: function (localmodel) {
      this.updateAssembly({ assembly: localmodel });
    },
