...
// You can navigate from any code in a Vue project (e.g., Vuex, startup, utilities, etc.). 
// To do this, just import the router object and use it like the injected $router object:
...
const actions = {
  ...
  syncProfile: ({ state, dispatch }, { oauthUserID, oauthUserEmail }) => {
  ...
  retrievePublicProfile({ commit, dispatch }, {}) {
