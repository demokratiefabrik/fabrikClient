...
<template>
  <q-page class="doc_content">
    <div class="row justify-between" v-if="!$loaded(ready)">
      <div class="seperator">
    ...
    <div v-if="ready">
      <h2>
        {{
          isManualFocusStage ? 'Zweites Thema:' : 'Der smartvote-Fragenkatalog:'
        }}
        Was wollen Sie von den Kandidierenden wissen, bevor Sie sie wählen?
      </h2>
      <a name="TOPICSELECTION" />

      <p>
        Hier geht es darum, ein breites Spektrum an relevanten politischen
        Fragen zusammenzustellen. Aus den von den Teilnehmenden der
        Demokratiefabrik am besten bewerteten Fragen bildet sich am Ende der
      ...
      <VAATopicSelector
        ...
        :disabled="
          VAAQuestionStagesAlerted &&
          VAAQuestionStagesAlerted.length &&
          focusedContent
        "
      />
      <ArtificialModeration
      ...
      <div
        ...
        v-if="
          detailView && !$loaded(nodeChildrenExceptUserPeerreviews) && contentID
        "
      >
        <div class="seperator">
          <q-spinner-dots size="2rem" />
      ...
      <transition name="fade">
        <div v-if="detailView && $loaded(nodeChildrenExceptUserPeerreviews)">
          ...
          <p v-if="nodeChildrenExceptUserPeerreviews.length === 0">
            Der Fragenkatalog zum Thema '{{ node.content.title }}' ist momentan
            noch leer.
          </p>
          <p v-else-if="nodeChildrenExceptUserPeerreviews.length == 1">
            Zu diesem Thema wurde bisher folgende Fragen '{{
              node.content.title
            }}' eingetragen. <br />
          </p>
          <p v-else-if="nodeChildrenExceptUserPeerreviews.length > 1">
            Zu diesem Thema wurden bisher
            {{ nodeChildrenExceptUserPeerreviews.length }} Fragen eingetragen.
            <br />
          </p>
          ...
          <div v-if="tooManyQuestions">
            <div v-if="areNodeChildrenLimited">
              Es werden
              {{ nodeChildrenExceptUserPeerreviewsLimited.length }} von
              {{ nodeChildrenExceptUserPeerreviews.length }} Fragen angezeigt.
              Klicken Sie auf 'Alle anzeigen' um sich alle Fragen zu diesem
            ...
            <div v-else>
              Es sind bereits einige Fragen zu diesem Thema eingetragen worden.
              Klicken Sie auf 'Weniger anzeigen' um nur eine zufällige Auswahl
              von Fragen eingeblendet zu lassen.
              <q-chip
                clickable
                size="1.2em"
          ...
          <Skeleton v-if="!milestoneSALIENCE" h2="Involvierte Gutachten" />
          ...
          <div v-if="milestoneSALIENCE">
            ...
            <p>
              Als Teilnehmerin und Teilnehmer der Demokratiefabrik sind Sie
              automatisch auch Gutachterin respektive Gutachter. Somit sind Sie
              mitverantwortlich, ob die vorgeschlagenen Fragen im Fragenkatalog
              der Demokratiefabrik verbleiben und somit die Chance erhalten
              bleibt, in den finalen smartvote-Fragebogen einzufliessen.
              <!-- <br><br> -->
            ...
            <div v-if="Object.values(contents_to_peerreview).length">
              ...
              <q-list>
                <PeerReviewListItem
                  v-for="(peerreviews, contentID) in Object.values(
            ...
            <div v-else class="text-notification">
          ...
          <Skeleton
            v-if="
              !milestonePEERREVIEW || !milestoneSALIENCE || !peerreviewCompleted
            "
          ...
          >
            <h2>
              <q-badge
                v-if="
                  milestonePROPOSE && milestoneSALIENCE && peerreviewCompleted
                "
                color="green"
                style="position: relative; top: -1em"
              >
            ...
            <p>
              Finden Sie, dass bisher ein wichtiger Aspekt des Themas '{{
                node.content.title
              }}' noch nicht abgedeckt ist? Dann reichen Sie hier einen Antrag
              für eine neue Frage ein!
            </p>
            <ArtificialModeration
          ...
          >
            <h2>
              <q-badge
                v-if="
                  milestoneCHARTS && milestoneSALIENCE && peerreviewCompleted
                "
                color="green"
                style="position: relative; top: -1em"
              >
            ...
            <p v-if="chartBarLabels.length">
              Sie sehen hier nun Ihre Bewertungen der Fragen zum Thema "{{
                node.content.title
              }}" im Vergleich zu denjenigen aller Teilnehmenden.
            </p>
            <p v-else class="text-notification">
              Es sind heute noch zu wenige Daten vorhanden. Die Rangfolge steht
              für dieses Thema noch nicht zur Verfügung.
            </p>
